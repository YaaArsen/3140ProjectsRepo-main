...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'http://https://github.com/YaaArsen/3140ProjectsRepo-main/blob/main/APIscripts.js'); // Replace with your client's origin
...
app.get('https://jstris.jezevec10.com/api/leaderboard/1?mode=1&offset=0', (req, res) => {
