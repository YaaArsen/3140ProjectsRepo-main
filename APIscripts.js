...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'http://https://github.com'); // Replace with your client's origin
...
app.get('http://jstris.jezevec10.com/api/leaderboard/<game>?mode=<mode>', (req, res) => {
